...
describe('UserController', () => {
  ...
  describe('guards', () => {
    ...
    it('check if guards are being used in method Index', () => {
      const guards: any[] = Reflect.getMetadata('__guards__', userController.index)
    ...
    it('check if guards are NOT being used in method Create', () => {
      const guards: any[] = Reflect.getMetadata('__guards__', userController.create)
      expect(guards).toBeUndefined()
    });

    it('check if guards are being used in method Read', () => {
      const guards: any[] = Reflect.getMetadata('__guards__', userController.read)
    ...
    it('check if guards are being used in method Update', () => {
      const guards: any[] = Reflect.getMetadata('__guards__', userController.update)
    ...
    it('check if guards are being used in method UpdatePatch', () => {
      const guards: any[] = Reflect.getMetadata('__guards__', userController.updateWithPatch)
    ...
    it('check if guards are being used in method Delete', () => {
      const guards: any[] = Reflect.getMetadata('__guards__', userController.delete)
  ...
  describe('CRUD methods',() => {
    ...
    it('UpdatePatch', async () => {
      const result = await userController.updateWithPatch(updatePutUserDTOMock, 1)
      expect(result).toEqual(userEntityList[0])
    });
